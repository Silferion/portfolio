...
const portfolioData = {
  'hfile-depot': {
    ...
    technologies: ['Node.js', 'Vue.js', 'MySQL', 'PHP Laravel', 'PDF Generation', 'Email Integration', 'REST API', 'Ubuntu Server', 'NGINX'],
    features: [
  ...
  'prms': {
    ...
    technologies: ['React.js', 'Next.js', 'Node.js', 'MySQL', 'Docker', 'PHP Laravel', 'REST API', 'Ubuntu Server', 'NGINX'],
    features: [
